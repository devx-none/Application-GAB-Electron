        ...
        {!enterNum &&
          Options.map((_, index) => (
            <button
              ...
              className={`w-5/12  p-5 m-5 flex gap-3 items-center rounded-xl shadow-md border-4 border-cih-dark border-solid text-omniya text-2xl font-extrabold bg-cih-gold ${
      ...
      {enterNum && (
        <>
          ...
          <button
            ...
            className="px-10 p-4 text-2xl text-gray-700 font-bold border-2  bg-cih-gold text-center rounded-lg focus:border-cih-gold"
          >
            Confirmer
          </button>
        </>
