...
import { createCarHandler , payCarHandler } from "./controller/car.controller";
...
export default function (app: Express) {
  ...
  //Get balance user
  app.get("/api/users/:userId/balance", getUserBalanceHandler);

//withdrawal money
  app.post("/api/users/:userId/withdrawal", getUserWithdrawalHandler);
  ...
  //pay vignette 
  app.post("/api/vignette", payCarHandler);
